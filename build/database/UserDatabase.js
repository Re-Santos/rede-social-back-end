...
class UserDatabase extends BaseDatabase_1.BaseDatabase {
    constructor() {
        super(...arguments);
        this.createUser = (userDB) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.getUserByEmail = (email) => __awaiter(this, void 0, void 0, function* () {
            const [user] = yield BaseDatabase_1.BaseDatabase
                .connection(UserDatabase.TABLE_USERS)
                .where({ email });
            return user;
        });
    ...
    getUsersById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield BaseDatabase_1.BaseDatabase.connection(UserDatabase.TABLE_USERS).where({ id: id });
            return result;
        });
    }
}
